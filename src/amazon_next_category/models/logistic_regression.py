...
def main() -> None:
    ...
    train_files = shard_files_arr[:n_train]
    val_files = shard_files_arr[n_train : n_train + n_val]
    test_files = shard_files_arr[n_train + n_val :]
    ...
    df_val = load_split_from_shards(list(val_files), MAX_VAL_ROWS, "val")
    df_test = load_split_from_shards(list(test_files), MAX_TEST_ROWS, "test")
